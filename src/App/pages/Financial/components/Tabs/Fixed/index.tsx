import useGetExpensesFixed from '@/api/queries/useGetExpensesFixed'
import { CustomTable } from '@/components/commons/CustomTable'
import { ICategory, IExpense } from '@/api/queries/types'
import {
  PaidButton,
  NameCell,
  DateCell,
...
const Fixed = () => {
  const { data: expensesFixed, isLoading } = useGetExpensesFixed()
